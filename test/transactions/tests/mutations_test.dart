...
import '../harness/mutations_test_harness.dart';

void main() {
  final di = GetIt.instance;
  late TestTelemetry telemetry;
  late TestAnalytics analytics;
  late MutationRepo repo;
  ...
  group('MutationMixins', () {
    test('throws when hooks are not installed', () async {
      final uninitialized = UninitializedMutationRepo()..data(1);
